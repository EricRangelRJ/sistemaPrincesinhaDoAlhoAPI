...
public class VendedoresController {
	...
	public ResponseEntity<VendedorGetDTO> cadastrar(@RequestBody VendedorPostDTO dto) {
	...
	public ResponseEntity<VendedorGetDTO> atualizar(@RequestBody VendedorPutDTO dto) {
